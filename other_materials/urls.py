...
urlpatterns = [
    ...
    path("export-malzeme_listesi/", export_category_stock, name="export_category_stock"),
    path("malzeme_listesi/", category_stock, name="category_stock"),
    path("yeni_malzeme_ekle/", new_category_stock, name="new_category_stock"),
    path("malzeme_düzenle/<int:id>/", edit_category_stock, name="edit_category_stock"),
    ...
    path("export-malzeme_cikis_islemleri/", export_category_stock_out, name="export_category_stock_out"),
